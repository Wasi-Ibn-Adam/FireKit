...
class PhoneText(
    ...
    init {
        ...
        spinner = view.findViewById(R.id.authkit_id_phonetext_spinner)
        editText = view.findViewById(R.id.authkit_id_phonetext_edittext)
        prepareView()
    }
    ...
    private fun prepareView() {
        ...
        setBackgroundResource(R.drawable.authkit_shape_extra_underline)
    }
